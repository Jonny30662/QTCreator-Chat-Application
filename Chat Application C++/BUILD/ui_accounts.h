...
public:
    ...
    void setupUi(QMainWindow *Accounts)
    {
        ...
        central_widget = new QWidget(Accounts);
...
"QLineEdit { border-radius: 3px; }"));
        ...
        sizePolicy2.setHeightForWidth(logoff_button->sizePolicy().hasHeightForWidth());
        logoff_button->setSizePolicy(sizePolicy2);
...
"QPushButton:hover { background-color: DarkOrange; }"));
        ...
        sizePolicy2.setHeightForWidth(shutdown_button->sizePolicy().hasHeightForWidth());
        shutdown_button->setSizePolicy(sizePolicy2);
...
"QPushButton:hover { background-color: #CE0000; }"));
        ...
        sidebar->setCursor(QCursor(Qt::ArrowCursor));
...
"}"));
        ...
        show_users_table = new QTableWidget(page_contents_widget);
        show_users_table->setObjectName(QString::fromUtf8("show_users_table"));
        show_users_table->viewport()->setProperty("cursor", QVariant(QCursor(Qt::PointingHandCursor)));
        show_users_table->verticalHeader()->setVisible(false);

        horizontalLayout_8->addWidget(show_users_table);

        horizontalSpacer = new QSpacerItem(200, 20, QSizePolicy::Preferred, QSizePolicy::Minimum);
        ...
        Accounts->setCentralWidget(central_widget);
        menubar = new QMenuBar(Accounts);
        menubar->setObjectName(QString::fromUtf8("menubar"));
        menubar->setGeometry(QRect(0, 0, 1042, 22));
        Accounts->setMenuBar(menubar);
        statusbar = new QStatusBar(Accounts);
        statusbar->setObjectName(QString::fromUtf8("statusbar"));
        Accounts->setStatusBar(statusbar);
    ...
    void retranslateUi(QMainWindow *Accounts)
    {
        Accounts->setWindowTitle(QApplication::translate("Accounts", "MainWindow", nullptr));
        current_date_time->setText(QApplication::translate("Accounts", "Date/Time", nullptr));
        account_name->setText(QApplication::translate("Accounts", "Account", nullptr));
        profile_pic->setText(QApplication::translate("Accounts", "profilepic", nullptr));
        logoff_button->setText(QString());
        shutdown_button->setText(QString());
        home_button->setText(QApplication::translate("Accounts", "Home", nullptr));
        chats_button->setText(QApplication::translate("Accounts", "Chats", nullptr));
        groups_button->setText(QApplication::translate("Accounts", "Groups", nullptr));
        accounts_button->setText(QApplication::translate("Accounts", "Accounts", nullptr));
        settings_button->setText(QApplication::translate("Accounts", "Settings", nullptr));
        manage_users_button->setText(QApplication::translate("Accounts", "Manage Users", nullptr));
        manage_groups_button->setText(QApplication::translate("Accounts", "Manage Groups", nullptr));
        manage_mods_button->setText(QApplication::translate("Accounts", "Manage Mods", nullptr));
        page_title_label->setText(QApplication::translate("Accounts", "Accounts", nullptr));
    } // retranslateUi
