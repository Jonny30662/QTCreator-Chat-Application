/********************************************************************************
** Form generated from reading UI file 'adminmanageusers.ui'
**
...
#ifndef UI_ADMINMANAGEUSERS_H
#define UI_ADMINMANAGEUSERS_H
...
public:
    ...
    void setupUi(QMainWindow *AdminManageUsers)
    {
        if (AdminManageUsers->objectName().isEmpty())
            AdminManageUsers->setObjectName(QString::fromUtf8("AdminManageUsers"));
        AdminManageUsers->resize(1390, 1012);
        central_widget = new QWidget(AdminManageUsers);
...
"}"));
        ...
        tableWidget->setMinimumSize(QSize(1050, 330));
        tableWidget->setMaximumSize(QSize(1050, 16777215));
...
""));
        ...
        label->setMinimumSize(QSize(1100, 200));
...
"}"));
        ...
        reset_button = new QPushButton(button_widget);
        ...
        AdminManageUsers->setCentralWidget(central_widget);
        menubar = new QMenuBar(AdminManageUsers);
        menubar->setObjectName(QString::fromUtf8("menubar"));
        menubar->setGeometry(QRect(0, 0, 1390, 22));
        AdminManageUsers->setMenuBar(menubar);
        statusbar = new QStatusBar(AdminManageUsers);
        statusbar->setObjectName(QString::fromUtf8("statusbar"));
        AdminManageUsers->setStatusBar(statusbar);

        retranslateUi(AdminManageUsers);

        QMetaObject::connectSlotsByName(AdminManageUsers);
    } // setupUi

    void retranslateUi(QMainWindow *AdminManageUsers)
    {
        AdminManageUsers->setWindowTitle(QApplication::translate("AdminManageUsers", "MainWindow", nullptr));
        current_date_time->setText(QApplication::translate("AdminManageUsers", "Date/Time", nullptr));
        account_name->setText(QApplication::translate("AdminManageUsers", "Account", nullptr));
        profile_pic->setText(QApplication::translate("AdminManageUsers", "profilepic", nullptr));
        logoff_button->setText(QString());
        shutdown_button->setText(QString());
        home_button->setText(QApplication::translate("AdminManageUsers", "Admin Home", nullptr));
        manage_users_button->setText(QApplication::translate("AdminManageUsers", "Manage Users", nullptr));
        manage_groups_button->setText(QApplication::translate("AdminManageUsers", "Manage Groups", nullptr));
        manage_mods_button->setText(QApplication::translate("AdminManageUsers", "Manage Mods", nullptr));
        main_menu_button->setText(QApplication::translate("AdminManageUsers", "Main Menu", nullptr));
        page_title_label->setText(QApplication::translate("AdminManageUsers", "Manage Users", nullptr));
        label->setText(QString());
        delete_button->setText(QApplication::translate("AdminManageUsers", "Delete user", nullptr));
        reset_button->setText(QApplication::translate("AdminManageUsers", "Reset password", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AdminManageUsers: public Ui_AdminManageUsers {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINMANAGEUSERS_H
