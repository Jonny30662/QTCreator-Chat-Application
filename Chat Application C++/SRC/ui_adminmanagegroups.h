/********************************************************************************
** Form generated from reading UI file 'adminmanagegroups.ui'
**
...
#ifndef UI_ADMINMANAGEGROUPS_H
#define UI_ADMINMANAGEGROUPS_H
...
public:
    ...
    void setupUi(QMainWindow *AdminManageGroups)
    {
        if (AdminManageGroups->objectName().isEmpty())
            AdminManageGroups->setObjectName(QString::fromUtf8("AdminManageGroups"));
        AdminManageGroups->resize(1390, 959);
        central_widget = new QWidget(AdminManageGroups);
...
"QLineEdit { border-radius: 3px; }"));
        ...
        currentDateTime = new QLabel(TopWidget);
        currentDateTime->setObjectName(QString::fromUtf8("currentDateTime"));

        horizontalLayout_9->addWidget(currentDateTime);
...
""));
        ...
        label->setMinimumSize(QSize(0, 125));
...
""));
        ...
        delete_button = new QPushButton(button_widget);
        delete_button->setObjectName(QString::fromUtf8("delete_button"));
        delete_button->setMinimumSize(QSize(0, 30));

        verticalLayout_3->addWidget(delete_button);

        remove_button = new QPushButton(button_widget);
        remove_button->setObjectName(QString::fromUtf8("remove_button"));
        remove_button->setMinimumSize(QSize(0, 30));

        verticalLayout_3->addWidget(remove_button);
        ...
        AdminManageGroups->setCentralWidget(central_widget);
        menubar = new QMenuBar(AdminManageGroups);
        menubar->setObjectName(QString::fromUtf8("menubar"));
        menubar->setGeometry(QRect(0, 0, 1390, 22));
        AdminManageGroups->setMenuBar(menubar);
        statusbar = new QStatusBar(AdminManageGroups);
        statusbar->setObjectName(QString::fromUtf8("statusbar"));
        AdminManageGroups->setStatusBar(statusbar);

        retranslateUi(AdminManageGroups);

        QMetaObject::connectSlotsByName(AdminManageGroups);
    } // setupUi

    void retranslateUi(QMainWindow *AdminManageGroups)
    {
        AdminManageGroups->setWindowTitle(QApplication::translate("AdminManageGroups", "MainWindow", nullptr));
        currentDateTime->setText(QApplication::translate("AdminManageGroups", "Date/Time", nullptr));
        account_name->setText(QApplication::translate("AdminManageGroups", "Account", nullptr));
        profile_pic->setText(QApplication::translate("AdminManageGroups", "profilepic", nullptr));
        logoff_button->setText(QString());
        shutdown_button->setText(QString());
        home_button->setText(QApplication::translate("AdminManageGroups", "Admin Home", nullptr));
        manage_users_button->setText(QApplication::translate("AdminManageGroups", "Manage Users", nullptr));
        manage_groups_button->setText(QApplication::translate("AdminManageGroups", "Manage Groups", nullptr));
        manage_mods_button->setText(QApplication::translate("AdminManageGroups", "Manage Mods", nullptr));
        main_menu_button->setText(QApplication::translate("AdminManageGroups", "Main Menu", nullptr));
        page_title_label->setText(QApplication::translate("AdminManageGroups", "Manage Groups", nullptr));
        label->setText(QString());
        promote_button->setText(QApplication::translate("AdminManageGroups", "Promote User", nullptr));
        demote_button->setText(QApplication::translate("AdminManageGroups", "Demote Moderator", nullptr));
        delete_button->setText(QApplication::translate("AdminManageGroups", "Delete group", nullptr));
        remove_button->setText(QApplication::translate("AdminManageGroups", "Remove member", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AdminManageGroups: public Ui_AdminManageGroups {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINMANAGEGROUPS_H
