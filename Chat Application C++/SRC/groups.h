...
private slots:
    ...
    /*!
    *\brief This function hides the UI and shows the create group chat page.
    */
    void on_create_group_button_clicked();

    /*!
    *\brief This function loads all the group chats on the database that the user is a member of, the table shows the group chat name.
    */
    void load_user_groups();

    /*!
    *\brief This function takes the data from the cell that has been clicked, updates the current_recipient variable and then takes you to the messaging page so that you can message the group that was clicked on.
    */
    void on_show_groupchats_table_cellClicked(int row, int column);
