...
private slots:
    ...
    /*!
    *\brief This function loads all the user accounts on the database apart from the admin account into a table, the table shows their profile picture, username and active_status.
    */
    void load_users();
    ...
    */
    void on_show_users_table_cellClicked(int row, int column);
